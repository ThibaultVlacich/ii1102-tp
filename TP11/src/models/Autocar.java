...
public class Autocar extends Vehicule {
  ...
  public Autocar(String _modele, int _anneeAchat, float _prixAchat, String _immatriculation, int _volume, int _nbPassagers) {
    super(_modele, _anneeAchat, _prixAchat, _immatriculation, 'D');
